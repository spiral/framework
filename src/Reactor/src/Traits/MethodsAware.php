...
trait MethodsAware
{
    public function setMethods(Methods $methods): static
    {
        $this->element->setMethods(\array_map(
            static fn (Method $method): \Nette\PhpGenerator\Method => $method->getElement(),
    ...
    public function getMethods(): Methods
    {
        return new Methods(\array_map(
            static fn (NetteMethod $method): \Spiral\Reactor\Partial\Method => Method::fromElement($method),
