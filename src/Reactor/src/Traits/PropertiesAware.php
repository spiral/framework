...
trait PropertiesAware
{
    public function setProperties(Properties $properties): static
    {
        $this->element->setProperties(\array_map(
            static fn (Property $property): \Nette\PhpGenerator\Property => $property->getElement(),
    ...
    public function getProperties(): Properties
    {
        return new Properties(\array_map(
            static fn (NetteProperty $property): \Spiral\Reactor\Partial\Property => Property::fromElement($property),
