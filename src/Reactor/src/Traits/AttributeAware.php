...
trait AttributeAware
{
    ...
    public function setAttributes(array $attributes): static
    {
        $this->element->setAttributes(\array_map(
            static fn (Attribute $attribute): \Nette\PhpGenerator\Attribute => $attribute->getElement(),
            $attributes
        ));
    ...
    {
        return \array_map(
            static fn (NetteAttribute $attribute): \Spiral\Reactor\Partial\Attribute => Attribute::fromElement($attribute),
