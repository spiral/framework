...
trait FunctionLike
{
    ...
    public function setParameters(Parameters $parameters): static
    {
        $this->element->setParameters(\array_map(
            static fn (Parameter $parameter): \Nette\PhpGenerator\Parameter => $parameter->getElement(),
    ...
    public function getParameters(): Parameters
    {
        return new Parameters(\array_map(
            static fn (NetteParameter $parameter): \Spiral\Reactor\Partial\Parameter => Parameter::fromElement($parameter),
