...
trait TraitsAware
{
    public function setTraits(TraitUses $traits): static
    {
        $this->element->setTraits(\array_map(
            static fn (TraitUse $traitUse): \Nette\PhpGenerator\TraitUse => $traitUse->getElement(),
    ...
    public function getTraits(): TraitUses
    {
        return new TraitUses(\array_map(
            static fn (NetteTraitUse $trait): \Spiral\Reactor\Partial\TraitUse => TraitUse::fromElement($trait),
