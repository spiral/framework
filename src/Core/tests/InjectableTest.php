...
class InjectableTest extends TestCase
{
    public function testMissingInjector(): void
    {
        ...
        $this->expectException(\Spiral\Core\Exception\Container\AutowireException::class);
    ...
    {
        $this->expectException(\Spiral\Core\Exception\Container\InjectionException::class);// instance of InjectorInterface for
        $this->expectExceptionMessage("Class 'Spiral\Tests\Core\Fixtures\InvalidInjector' must be an
                           instance of InjectorInterface for
                           'Spiral\Tests\Core\Fixtures\TestConfig'");
        $container = new Container();
    ...
    {
        $this->expectException(\Spiral\Core\Exception\Container\InjectionException::class);// 'Spiral\Tests\Core\Fixtures\TestConfig'
        $this->expectExceptionMessage("Invalid injection response for
                           'Spiral\Tests\Core\Fixtures\TestConfig'");
        $container = new Container();
