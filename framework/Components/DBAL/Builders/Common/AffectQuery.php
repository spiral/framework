...
abstract class AffectQuery extends QueryBuilder
{
    ...
    /**
     * Table name to affect data into, should not include postfix. Setter method is not provided as it can be named differently
     * in different builders.
     *
     * @var string
     */
    protected $table = '';
    ...
    /**
     * Reasonable only if limit of offset values specified, will affect matched records in specified order.
     *
     ...
     * Affect query builder will return count affected rows.
     *
     * @return int
     */
    public function run()
    {
        ...
        {
            $this->logger()->warning("Affect query performed without any condition or search limitation, whole table will be updated.");
        }
