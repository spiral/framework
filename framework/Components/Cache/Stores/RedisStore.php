...
class RedisStore extends CacheStore
{
     ...
     *
     * @param string $name  Stored value name.
     * @param int    $delta How much to increment by. 1 by default.  MAYBE "WRITE HOW MUCH TO CHANGE BY?"
     * @return mixed
     */
     ...
     *
     * @param string $name  Stored value name.
     * @param int    $delta How much to decrement by. 1 by default.  SAME ISSUES AS ABOVE HERE???
     * @return mixed
     */
