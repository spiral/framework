...
The Spiral framework provides open and modular Rapid Application Development (RAD) platform to create applications using an HMVC architecture (optional), layers separation, code re-usability, extremely friendy IoC, PSR-7, simple syntax and customizable scaffolding mechanisms.
