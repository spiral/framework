...
The Spiral framework provides open and modular Rapid Application Development (RAD) platform to create applications using an HMVC architecture (optional), layers separation, code re-usability, extremely friendly IoC, PSR-7, simple syntax and customizable scaffolding mechanisms.
...
> Spiral framework guide is still in development.
...
Declarative/lazy singletons and services (no need to torture IoC all the time):
...
Inspired by
===========
Laravel 5+, CodeIgniter, Yii 2, Symfony 2, Ruby on Rails, Spring.
