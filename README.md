...
The Spiral framework provides a modular Rapid Application Development (RAD) platform to develop web applications using an HMVC architecture, layers separation, code re-usability, PSR-7, simple syntax and customizable scaffolding mechanisms.
