...
class ViewManager extends Component implements SingletonInterface, ViewsInterface
{
     ...
     */
    public function get($path, array $context = [], $class = null)
    {
    ...
    public function getViews($namespace)
    {
        if (!isset($this->namespaces[$namespace])) {
            throw new ViewsException("Invalid view namespace '{$namespace}'.");
        }
    ...
    {
        if (!isset($this->namespaces[$namespace])) {
            throw new ViewsException("Undefined view namespace '{$namespace}'.");
        }
        ...
        throw new ViewsException("Unable to find view '{$view}' in namespace '{$namespace}'.");
    }
