...
class ValueHelperTest extends TestCase
{
    public function testString()
    {
        ...
        $this->assertInternalType('string', ValueHelper::castString([]));
    ...
    public function testBoolean()
    {
        ...
        $this->assertInternalType('boolean', ValueHelper::castBoolean([]));
    ...
    public function testScalarArray()
    {
        ...
        $this->assertInternalType('array', ValueHelper::scalarArray([]));

        $this->assertSame([1], ValueHelper::scalarArray([
            new \StdClass(),
            1,
            []
        ]));

        $this->assertSame([1, 'abc'], ValueHelper::scalarArray([
            new \StdClass(),
            1,
            [],
            'abc',
