 ...
 * @method static ViewInterface get($view, array $data = array())
 * @method static string render($view, array $data = array())
 * @method static ViewManager make($parameters = array(), Container $container = null)
