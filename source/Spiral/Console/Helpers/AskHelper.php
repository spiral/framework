...
class AskHelper
{
     ...
     * @return $this|self
     */
    public function maxAttempts($maxAttempts): AskHelper
    {
     ...
     * @return $this|self
     */
    public function hidden(bool $hidden = true, bool $fallback = true): AskHelper
    {
        $this->hidden = $hidden;
     ...
     * @return mixed
     */
    public function input(string $question, $default = null)
    {
     ...
     * @return mixed
     */
    public function confirm(string $question, $default = null)
    {
     ...
     * @return mixed
     */
    public function choice(string $question, array $options, $default = null)
    {
